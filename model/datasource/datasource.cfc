<cfcomponent name="datasource" displayname="datasource" hint="a datasource bean" output="false">
	<cfproperty name="dsnName" type="string" required="false" default="" />
	<cfproperty name="dsnType" type="string" required="false" default="" />
	
	<cffunction name="init" access="public" output="false" returntype="nextgenerator.model.datasource.datasource">
	...
	<cffunction name="setDbms" access="public" output="false" returntype="void">
		<cfset variables.dbms = createObject("component","nextgenerator.model.datasource.#getDsnType()#").init(getDsnName()) />
	</cffunction>
